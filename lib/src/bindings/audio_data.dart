...
class AudioData {
  ...
  late void Function(AudioDataCtrl) _updateCallback;
  ...
  bool get isEmpty => _getSamplesKind == GetSamplesKind.texture
      ...
      : _getSamplesKind == GetSamplesKind.linear
          ? ctrl.isEmptyLinear()
          : ctrl.isEmptyTexture(); // GetSamplesKind.wave
}
