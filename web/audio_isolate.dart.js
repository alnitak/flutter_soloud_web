...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _Record_2_error_newHandle: function _Record_2_error_newHandle(t0, t1) {
      this._0 = t0;
      this._1 = t1;
    },
    _Record_2_error_sound: function _Record_2_error_sound(t0, t1) {
      this._0 = t0;
      this._1 = t1;
    },
    _Record_2_error_soundHash: function _Record_2_error_soundHash(t0, t1) {
      this._0 = t0;
      this._1 = t1;
    },
    _Record_3_event_handle_sound: function _Record_3_event_handle_sound(t0, t1, t2) {
      this._0 = t0;
      this._1 = t1;
      this._2 = t2;
    },
    ...
    _parseEventData(data) {
      var exception,
        t1 = type$.dynamic,
        ret = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      $label0$0: {
        ...
        if (typeof data == "string")
          try {
            ret = t1._as(B.C_JsonCodec.decode$2$reviver(0, data, null));
          } catch (exception) {
            A.print("_parseEventData: failed to parse [" + data + "]");
          }
      }
      return ret;
    },
    audioIsolate(isolateToMainStream) {
      return A.audioIsolate$body(isolateToMainStream);
    },
    audioIsolate$body(isolateToMainStream) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        worker, t2, soLoudController, activeSounds, t1;
      var $async$audioIsolate = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = {};
              A.print("Worker created. isolateToMainStream: " + A.S(isolateToMainStream) + "\n");
              self.self.importScripts("libflutter_soloud_plugin.js");
              worker = A.Worker$(isolateToMainStream);
              t2 = worker.__Worker__outputController_A;
              t2 === $ && A.throwLateFieldNI("_outputController");
              soLoudController = $.SoLoudController__instance;
              if (soLoudController == null) {
                soLoudController = new A.SoLoudController();
                soLoudController._isInitialized = new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_bool), type$._AsyncCompleter_bool);
                soLoudController.initialize$0(0);
                $.SoLoudController__instance = soLoudController;
              }
              activeSounds = A._setArrayType([], type$.JSArray_AudioSource);
              t1.loopRunning = false;
              new A._ControllerStream(t2, A._instanceType(t2)._eval$1("_ControllerStream<1>")).listen$1(new A.audioIsolate_closure(t1, soLoudController, worker, activeSounds));
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$audioIsolate, $async$completer);
    },
    main() {
      A.audioIsolate(null);
    },
    MessageEvents: function MessageEvents(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    audioIsolate_closure: function audioIsolate_closure(t0, t1, t2, t3) {
      var _ = this;
      _._box_1 = t0;
      _.soLoudController = t1;
      _.worker = t2;
      _.activeSounds = t3;
    },
    audioIsolate__closure: function audioIsolate__closure(t0) {
      this.ret = t0;
    },
    audioIsolate__closure0: function audioIsolate__closure0(t0, t1) {
      this._box_0 = t0;
      this.ret = t1;
    },
    audioIsolate__closure1: function audioIsolate__closure1(t0) {
      this.ret = t0;
    },
    audioIsolate__closure2: function audioIsolate__closure2(t0, t1) {
      this._box_0 = t0;
      this.ret = t1;
    },
    audioIsolate__closure3: function audioIsolate__closure3(t0) {
      this.args = t0;
    },
    audioIsolate__closure4: function audioIsolate__closure4(t0, t1, t2) {
      this.sound = t0;
      this.handle = t1;
      this.worker = t2;
    },
    audioIsolate__closure5: function audioIsolate__closure5(t0) {
      this.worker = t0;
    },
    AudioSource$(soundHash) {
      return new A.AudioSource(soundHash, A.LinkedHashSet_LinkedHashSet$_empty(type$.int));
    },
    AudioSource: function AudioSource(t0, t1) {
      this.soundHash = t0;
      this.__AudioSource_handles_FI = $;
      this.handlesInternal = t1;
    },
    SoundEventType: function SoundEventType(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    JSSoloudPlayer: function JSSoloudPlayer() {
    },
    PlayerErrors: function PlayerErrors(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    WaveForm: function WaveForm(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    LoadMode: function LoadMode(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    SoLoudController: function SoLoudController() {
      this._isInitialized = null;
      this.__SoLoudController__soLoudFFI_F = $;
    },
    ...
    JSObjectUnsafeUtilExtension_callMethod(_this, method, arg1, $T) {
      return $T._as(A.JSObjectUnsafeUtilExtension__callMethod(_this, method, arg1, null, null, null));
    },
  ...
  A._Record_2_error_newHandle.prototype = {$recipe: "+error,newHandle(1,2)", $shape: 1};
  A._Record_2_error_sound.prototype = {$recipe: "+error,sound(1,2)", $shape: 2};
  A._Record_2_error_soundHash.prototype = {$recipe: "+error,soundHash(1,2)", $shape: 3};
  A._Record_3_event_handle_sound.prototype = {$recipe: "+event,handle,sound(1,2,3)", $shape: 4};
  ...
  A.MessageEvents.prototype = {
    _enumToString$0() {
      return "MessageEvents." + this._name;
    }
  };
  A.audioIsolate_closure.prototype = {
    call$1(data) {
      var $event, args, ret, ret0, t1, t2, _this0, s, t3, hashPtr, pathPtr, result, hash, newSound, t4, t5, exception, t6, t7, t8, t9, t10, _i, sound, removeInvalid, b, _i0, _this = this, _s5_ = "event", _null = null,
        _s51_ = "]]]]]]]]]]]]]]] WORKER MessageEvents.loadSoLoudJS  ",
        _s9_ = "soundHash",
        _s11_ = "postMessage",
        _s5_0 = "error",
        _s14_ = "loopingStartAt",
        _box_0 = {},
        newData = A._parseEventData(data);
      A.print("******** audioIsolate()1: " + A.S(newData));
      t1 = J.getInterceptor$ax(newData);
      t2 = A._asInt(t1.$index(newData, _s5_));
      if (!(t2 >= 0 && t2 < 12))
        return A.ioore(B.List_ooe, t2);
      $event = B.List_ooe[t2];
      A.print("******** audioIsolate()2: " + A.S($event));
      args = A._parseEventData(t1.$index(newData, "args"));
      A.print("******** audioIsolate()3: " + A.S(args));
      if ($event !== B.MessageEvents_2)
        A.print("******** ISOLATE EVENT data: " + A.S(data));
      switch ($event) {
        case B.MessageEvents_11:
          _this0 = A._asInt(J.$index$ax(args, "handle"));
          A.print(_s51_ + _this0);
          A.print(_s51_ + _this.soLoudController.get$soLoudFFI().getIsValidVoiceHandle$1(_this0));
          break;
        case B.MessageEvents_0:
          t2 = _this.soLoudController;
          A.print("*** INITENGINE1  " + t2.get$soLoudFFI().initEngine$0());
          s = A._asInt(t2.get$soLoudFFI().loadWaveform$4(B.WaveForm_8, true, 1, 1).$index(0, _s9_));
          A.print("*** INITENGINE2  " + s);
          A.print("*** INITENGINE3  " + t2.get$soLoudFFI().play$1(0, s).toString$0(0));
          t2 = type$.dynamic;
          t3 = type$.String;
          A.print("@@@@@@@@@@@ MessageEvents.initEngine ret: " + B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["event", t1.$index(newData, _s5_), "args", A.LinkedHashMap_LinkedHashMap$_empty(t2, t2), "return", A.LinkedHashMap_LinkedHashMap$_empty(t2, t2)], t3, t2), _null));
          t2 = B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["event", t1.$index(newData, _s5_), "args", A.LinkedHashMap_LinkedHashMap$_empty(t2, t2), "return", 0], t3, t2), _null);
          A.JSObjectUnsafeUtilExtension_callMethod(type$.JSObject._as(self), _s11_, t2, type$.nullable_Object);
          break;
        case B.MessageEvents_3:
          _this.soLoudController.get$soLoudFFI();
          t1 = A._asString(J.$index$ax(args, "completeFileName"));
          t2 = type$.LoadMode._as(J.$index$ax(args, "mode"));
          t3 = self;
          hashPtr = A._asInt(t3.Module._malloc(4));
          pathPtr = A._asInt(t3.Module._malloc(t1.length));
          t1 = t3.Module;
          t2 = t2 === B.LoadMode_0 && true;
          result = A._asInt(t1._loadFile(pathPtr, t2, hashPtr));
          hash = A._asInt(t3.Module.getValue(hashPtr, "*"));
          if (!(result >= 0 && result < 17))
            return A.ioore(B.List_MUB, result);
          t2 = B.List_MUB[result];
          ret = new A._Record_2_error_soundHash(t2, hash);
          t3.Module._free(hashPtr);
          t3.Module._free(pathPtr);
          A.print("@@@@@@@@@@@ ret: " + ret.toString$0(0));
          if (t2 === B.PlayerErrors_0_noError) {
            newSound = A.AudioSource$(hash);
            B.JSArray_methods.add$1(_this.activeSounds, newSound);
          } else if (t2 === B.PlayerErrors_4_fileAlreadyLoaded) {
            _box_0.isAlreadyThere = true;
            t1 = _this.activeSounds;
            newSound = B.JSArray_methods.firstWhere$2$orElse(t1, new A.audioIsolate__closure(ret), new A.audioIsolate__closure0(_box_0, ret));
            if (!_box_0.isAlreadyThere)
              B.JSArray_methods.add$1(t1, newSound);
          } else
            newSound = _null;
          t1 = A.LinkedHashMap_LinkedHashMap$_literal(["event", $event, "args", args, "return", new A._Record_2_error_sound(t2, newSound)], type$.String, type$.Object);
          A.JSObjectUnsafeUtilExtension_callMethod(type$.JSObject._as(t3), _s11_, t1, type$.nullable_Object);
          break;
        case B.MessageEvents_4:
          ret = _this.soLoudController.get$soLoudFFI().loadWaveform$4(type$.WaveForm._as(J.$index$ax(args, "waveForm")), A._asBool(J.$index$ax(args, "superWave")), A._asDouble(J.$index$ax(args, "scale")), A._asDouble(J.$index$ax(args, "detune")));
          if (ret.$index(0, _s5_0) === B.PlayerErrors_0_noError) {
            newSound = A.AudioSource$(A._asInt(ret.$index(0, _s9_)));
            B.JSArray_methods.add$1(_this.activeSounds, newSound);
          } else if (ret.$index(0, _s5_0) === B.PlayerErrors_4_fileAlreadyLoaded) {
            _box_0.isAlreadyThere = true;
            t1 = _this.activeSounds;
            newSound = B.JSArray_methods.firstWhere$2$orElse(t1, new A.audioIsolate__closure1(ret), new A.audioIsolate__closure2(_box_0, ret));
            if (!_box_0.isAlreadyThere)
              B.JSArray_methods.add$1(t1, newSound);
          } else
            newSound = _null;
          t1 = type$.String;
          t1 = A.LinkedHashMap_LinkedHashMap$_literal(["event", $event, "args", args, "return", A.LinkedHashMap_LinkedHashMap$_literal(["error", ret.$index(0, _s5_0), "sound", newSound], t1, type$.dynamic)], t1, type$.Object);
          A.JSObjectUnsafeUtilExtension_callMethod(type$.JSObject._as(self), _s11_, t1, type$.nullable_Object);
          break;
        case B.MessageEvents_5:
          _this.soLoudController.get$soLoudFFI().speechText$1(A._asString(J.$index$ax(args, "textToSpeech")));
          break;
        case B.MessageEvents_6:
          t1 = _this.soLoudController.get$soLoudFFI();
          t2 = A._asInt(J.$index$ax(args, _s9_));
          t3 = A._asDouble(J.$index$ax(args, "volume"));
          t4 = A._asDouble(J.$index$ax(args, "pan"));
          t5 = A._asBool(J.$index$ax(args, "paused"));
          ret = t1.play$6$looping$loopingStartAt$pan$paused$volume(0, t2, A._asBool(J.$index$ax(args, "looping")), type$.Duration._as(J.$index$ax(args, _s14_)), t4, t5, t3);
          if (ret._0 !== B.PlayerErrors_0_noError) {
            t1 = type$.String;
            t2 = type$.nullable_Object;
            t1 = A.LinkedHashMap_LinkedHashMap$_literal(["event", $event, "args", args, "return", A.LinkedHashMap_LinkedHashMap$_literal(["error", ret._0, "newHandle", -1], t1, t2)], t1, type$.Object);
            A.JSObjectUnsafeUtilExtension_callMethod(type$.JSObject._as(self), _s11_, t1, t2);
            break;
          }
          try {
            B.JSArray_methods.firstWhere$1(_this.activeSounds, new A.audioIsolate__closure3(args)).handlesInternal.add$1(0, ret._1);
          } catch (exception) {
            A.print("No sound with soundHash " + A.S(J.$index$ax(args, _s9_)) + " found!");
            t1 = A.LinkedHashMap_LinkedHashMap$_literal(["event", $event, "args", args, "return", new A._Record_2_error_newHandle(B.PlayerErrors_10_soundHashNotFound, -1)], type$.String, type$.Object);
            t2 = self;
            A.JSObjectUnsafeUtilExtension_callMethod(type$.JSObject._as(t2), _s11_, t1, type$.nullable_Object);
            break;
          }
          t1 = A.LinkedHashMap_LinkedHashMap$_literal(["event", $event, "args", args, "return", new A._Record_2_error_newHandle(B.PlayerErrors_0_noError, ret._1)], type$.String, type$.Object);
          A.JSObjectUnsafeUtilExtension_callMethod(type$.JSObject._as(self), _s11_, t1, type$.nullable_Object);
          break;
        case B.MessageEvents_8:
          _this.soLoudController.get$soLoudFFI().stop$1(0, A._asInt(J.$index$ax(args, "handle")));
          break;
        case B.MessageEvents_9:
          _this.soLoudController.get$soLoudFFI().disposeSound$1(A._asInt(J.$index$ax(args, _s9_)));
          break;
        case B.MessageEvents_10:
          _this.soLoudController.get$soLoudFFI().disposeAllSound$0();
          break;
        case B.MessageEvents_7:
          t1 = _this.soLoudController.get$soLoudFFI();
          t2 = A._asInt(J.$index$ax(args, _s9_));
          t3 = A._asDouble(J.$index$ax(args, "posX"));
          t4 = A._asDouble(J.$index$ax(args, "posY"));
          t5 = A._asDouble(J.$index$ax(args, "posZ"));
          t6 = A._asDouble(J.$index$ax(args, "velX"));
          t7 = A._asDouble(J.$index$ax(args, "velY"));
          t8 = A._asDouble(J.$index$ax(args, "velZ"));
          t9 = A._asDouble(J.$index$ax(args, "volume"));
          t10 = A._asBool(J.$index$ax(args, "paused"));
          ret0 = t1.play3d$11$looping$loopingStartAt$paused$velX$velY$velZ$volume(t2, t3, t4, t5, A._asBool(J.$index$ax(args, "looping")), type$.Duration._as(J.$index$ax(args, _s14_)), t10, t6, t7, t8, t9);
          break;
        case B.MessageEvents_1:
          _this._box_1.loopRunning = true;
          t1 = type$.String;
          t2 = type$.Object;
          t3 = A.LinkedHashMap_LinkedHashMap$_literal(["event", B.MessageEvents_1, "args", B.C_Record0, "return", B.C_Record0], t1, t2);
          t4 = type$.JSObject._as(self);
          t5 = type$.nullable_Object;
          A.JSObjectUnsafeUtilExtension_callMethod(t4, _s11_, t3, t5);
          A.JSObjectUnsafeUtilExtension_callMethod(t4, _s11_, A.LinkedHashMap_LinkedHashMap$_literal(["event", B.MessageEvents_2, "args", B.C_Record0], t1, t2), t5);
          break;
        case B.MessageEvents_2:
          if (_this._box_1.loopRunning) {
            for (t1 = _this.activeSounds, t2 = t1.length, t3 = _this.soLoudController, t4 = _this.worker, t5 = type$.JSArray_of_void_Function, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
              sound = t1[_i];
              removeInvalid = A._setArrayType([], t5);
              for (t6 = sound.handlesInternal, t7 = t6.$ti, t8 = new A._LinkedHashSetIterator(t6, t6._collection$_modifications, t7._eval$1("_LinkedHashSetIterator<1>")), t8._collection$_cell = t6._collection$_first, t7 = t7._precomputed1; t8.moveNext$0();) {
                t6 = t8._collection$_current;
                if (t6 == null)
                  t6 = t7._as(t6);
                t3.get$soLoudFFI();
                A.printString(string$.JSSolo + A.S(t6));
                b = A._asInt(self.Module._getIsValidVoiceHandle(t6));
                A.printString("JSSoloudPlayer getIsValidVoiceHandle: " + b);
                if (b !== 1)
                  B.JSArray_methods.add$1(removeInvalid, new A.audioIsolate__closure4(sound, t6, t4));
              }
              for (t6 = removeInvalid.length, _i0 = 0; _i0 < removeInvalid.length; removeInvalid.length === t6 || (0, A.throwConcurrentModificationError)(removeInvalid), ++_i0)
                removeInvalid[_i0].call$0();
            }
            A.Future_Future$delayed(B.Duration_10000, new A.audioIsolate__closure5(t4), type$.Null);
          }
          break;
      }
    },
  ...
  A.audioIsolate__closure.prototype = {
    call$1(s) {
      return type$.AudioSource._as(s).soundHash === this.ret._1;
    },
    $signature: 3
  };
  A.audioIsolate__closure0.prototype = {
    call$0() {
      this._box_0.isAlreadyThere = false;
      return A.AudioSource$(this.ret._1);
    },
    $signature: 10
  };
  A.audioIsolate__closure1.prototype = {
    call$1(s) {
      return type$.AudioSource._as(s).soundHash === this.ret.$index(0, "soundHash");
    },
    $signature: 3
  };
  A.audioIsolate__closure2.prototype = {
    call$0() {
      this._box_0.isAlreadyThere = false;
      return A.AudioSource$(A._asInt(this.ret.$index(0, "soundHash")));
    },
    $signature: 10
  };
  A.audioIsolate__closure3.prototype = {
    call$1(s) {
      return type$.AudioSource._as(s).soundHash === A._asInt(J.$index$ax(this.args, "soundHash"));
    },
    $signature: 3
  };
  A.audioIsolate__closure4.prototype = {
    call$0() {
      var t1 = this.sound,
        t2 = this.handle;
      t1.handlesInternal.remove$1(0, t2);
      A.JSObjectUnsafeUtilExtension_callMethod(type$.JSObject._as(self), "postMessage", new A._Record_3_event_handle_sound(B.SoundEventType_0, t2, t1), type$.nullable_Object);
    },
    $signature: 0
  };
  A.audioIsolate__closure5.prototype = {
    call$0() {
      var t1 = A.LinkedHashMap_LinkedHashMap$_literal(["event", B.MessageEvents_2, "args", B.C_Record0], type$.String, type$.Object);
      A.JSObjectUnsafeUtilExtension_callMethod(type$.JSObject._as(self), "postMessage", t1, type$.nullable_Object);
    },
    $signature: 2
  };
  A.AudioSource.prototype = {
    toString$0(_) {
      var result, _this = this,
        value = _this.__AudioSource_handles_FI;
      if (value === $) {
        result = new A.UnmodifiableSetView(_this.handlesInternal, type$.UnmodifiableSetView_int);
        value !== $ && A.throwLateFieldADI("handles");
        _this.set$__AudioSource_handles_FI(result);
        value = result;
      }
      return "soundHash: " + _this.soundHash + " has " + value._source._collection$_length + " active handles";
    },
    set$__AudioSource_handles_FI(__AudioSource_handles_FI) {
      this.__AudioSource_handles_FI = type$.UnmodifiableSetView_int._as(__AudioSource_handles_FI);
    }
  };
  A.SoundEventType.prototype = {
    _enumToString$0() {
      return "SoundEventType." + this._name;
    }
  };
  A.JSSoloudPlayer.prototype = {
    initEngine$0() {
      var a = A._asInt(self.Module._initEngine());
      A.print("[[[[[[[[[[[[]]]]]]]]]]]] initEngine()  " + a + "  " + A.S(this.get$initEngine()));
      return a;
    },
    loadWaveform$4(waveform, superWave, scale, detune) {
      var ret,
        t1 = self,
        hashPtr = A._asInt(t1.Module._malloc(4)),
        result = A.callMethod(t1.Module, "_loadWaveform", [waveform.index, superWave, scale, detune, hashPtr], type$.int),
        hash = A._asInt(t1.Module.getValue(hashPtr, "*"));
      if (result >>> 0 !== result || result >= 17)
        return A.ioore(B.List_MUB, result);
      ret = A.LinkedHashMap_LinkedHashMap$_literal(["error", B.List_MUB[result], "soundHash", hash], type$.String, type$.nullable_Object);
      t1.Module._free(hashPtr);
      return ret;
    },
    play$6$looping$loopingStartAt$pan$paused$volume(_, soundHash, looping, loopingStartAt, pan, paused, volume) {
      var t2,
        t1 = self,
        handlePtr = A._asInt(t1.Module._malloc(4)),
        result = A.callMethod(t1.Module, "_play", [soundHash, volume, pan, paused, looping, loopingStartAt._duration / 1000000, handlePtr], type$.int),
        handle = A._asInt(t1.Module.getValue(handlePtr, "*"));
      if (result >>> 0 !== result || result >= 17)
        return A.ioore(B.List_MUB, result);
      t2 = B.List_MUB[result];
      t1.Module._free(handlePtr);
      return new A._Record_2_error_newHandle(t2, handle);
    },
    play$1(_, soundHash) {
      return this.play$6$looping$loopingStartAt$pan$paused$volume(0, soundHash, false, B.Duration_0, 0, false, 1);
    },
    stop$1(_, handle) {
      throw A.wrapException(A.UnimplementedError$(null));
    },
    disposeSound$1(soundHash) {
      throw A.wrapException(A.UnimplementedError$(null));
    },
    disposeAllSound$0() {
      throw A.wrapException(A.UnimplementedError$(null));
    },
    speechText$1(textToSpeech) {
      throw A.wrapException(A.UnimplementedError$(null));
    },
    play3d$11$looping$loopingStartAt$paused$velX$velY$velZ$volume(soundHash, posX, posY, posZ, looping, loopingStartAt, paused, velX, velY, velZ, volume) {
      throw A.wrapException(A.UnimplementedError$(null));
    },
    getIsValidVoiceHandle$1(handle) {
      var b;
      A.print(string$.JSSolo + handle);
      b = A._asInt(self.Module._getIsValidVoiceHandle(handle));
      A.print("JSSoloudPlayer getIsValidVoiceHandle: " + b);
      return b === 1;
    }
  };
  A.PlayerErrors.prototype = {
    _enumToString$0() {
      return "PlayerErrors." + this._name;
    },
    get$_asSentence() {
      var _s17_ = "Filter not found!";
      switch (this.index) {
        case 0:
          return "No error";
        case 1:
        ...
        case 9:
          return "Capture null pointer error. Could happens when passing a non initialized pointer (with calloc()) to retrieve FFT or wave data. Or, setVisualization has not been enabled.";
        case 10:
        ...
        case 12:
          return _s17_;
        case 13:
          return "Asking for audio data is not enabled! Please use `setVisualizationEnabled(true);` to enable!";
        case 14:
    ...
    toString$0(_) {
      return "PlayerErrors." + this._name + " (" + this.get$_asSentence() + ")";
    }
  };
  A.WaveForm.prototype = {
    _enumToString$0() {
      return "WaveForm." + this._name;
    }
  };
  A.LoadMode.prototype = {
    _enumToString$0() {
      return "LoadMode." + this._name;
    }
  };
  A.SoLoudController.prototype = {
    get$soLoudFFI() {
      var t1 = this._isInitialized;
      t1 = t1 == null ? null : (t1.future._state & 30) !== 0;
      if (t1 === true) {
        t1 = this.__SoLoudController__soLoudFFI_F;
        t1 === $ && A.throwLateFieldNI("_soLoudFFI");
        return t1;
      }
      throw A.wrapException(A.AsyncError$("error", new A._StringStackTrace("stackTrace")));
    },
    initialize$0(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
      ...
      var $async$initialize$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$self.__SoLoudController__soLoudFFI_F !== $ && A.throwLateFieldAI("_soLoudFFI");
              $async$self.__SoLoudController__soLoudFFI_F = new A.JSSoloudPlayer();
              t1 = $async$self._isInitialized;
              if (t1 != null)
  ...
  (function installTearOffs() {
    ...
    _instance_0_u(A.JSSoloudPlayer.prototype, "get$initEngine", "initEngine$0", 20);
  })();
  (function inheritance() {
    ...
    _inheritMany(A._Record, [A._Record2, A._Record3, A._EmptyRecord]);
    _inheritMany(A._Record2, [A._Record_2_error_newHandle, A._Record_2_error_sound, A._Record_2_error_soundHash]);
    _inherit(A._Record_3_event_handle_sound, A._Record3);
    _inherit(A._UnmodifiableMapView_MapView__UnmodifiableMapMixin, A.MapView);
    _inherit(A.UnmodifiableMapView, A._UnmodifiableMapView_MapView__UnmodifiableMapMixin);
    _inherit(A.ConstantMapView, A.UnmodifiableMapView);
    _inherit(A.ConstantStringMap, A.ConstantMap);
    _inheritMany(A.Closure, [A.Closure2Args, A.Closure0Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._SyncBroadcastStreamController__sendData_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A.audioIsolate_closure, A.audioIsolate__closure, A.audioIsolate__closure1, A.audioIsolate__closure3, A.callbackToStream_closure, A.Worker_closure]);
    ...
    _inheritMany(A._Enum, [A.MessageEvents, A.SoundEventType, A.PlayerErrors, A.WaveForm, A.LoadMode]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      AudioSource: findType("AudioSource"),
      ...
      JSArray_AudioSource: findType("JSArray<AudioSource>"),
      ...
      UnmodifiableSetView_int: findType("UnmodifiableSetView<int>"),
      WaveForm: findType("WaveForm"),
...
;
    ...
    B.PlayerErrors_0_noError = new A.PlayerErrors(0, "noError");
    B.PlayerErrors_1_invalidParameter = new A.PlayerErrors(1, "invalidParameter");
    B.PlayerErrors_2_fileNotFound = new A.PlayerErrors(2, "fileNotFound");
    B.PlayerErrors_3_fileLoadFailed = new A.PlayerErrors(3, "fileLoadFailed");
    B.PlayerErrors_4_fileAlreadyLoaded = new A.PlayerErrors(4, "fileAlreadyLoaded");
    B.PlayerErrors_5_dllNotFound = new A.PlayerErrors(5, "dllNotFound");
    B.PlayerErrors_6_outOfMemory = new A.PlayerErrors(6, "outOfMemory");
    B.PlayerErrors_7_notImplemented = new A.PlayerErrors(7, "notImplemented");
    B.PlayerErrors_8_unknownError = new A.PlayerErrors(8, "unknownError");
    B.PlayerErrors_9_nullPointer = new A.PlayerErrors(9, "nullPointer");
    B.PlayerErrors_10_soundHashNotFound = new A.PlayerErrors(10, "soundHashNotFound");
    B.PlayerErrors_11_backendNotInited = new A.PlayerErrors(11, "backendNotInited");
    B.PlayerErrors_12_filterNotFound = new A.PlayerErrors(12, "filterNotFound");
    B.PlayerErrors_13_visualizationNotEnabled = new A.PlayerErrors(13, "visualizationNotEnabled");
    B.PlayerErrors_14_maxNumberOfFiltersReached = new A.PlayerErrors(14, "maxNumberOfFiltersReached");
    B.PlayerErrors_15_filterAlreadyAdded = new A.PlayerErrors(15, "filterAlreadyAdded");
    B.PlayerErrors_16_playerAlreadyInited = new A.PlayerErrors(16, "playerAlreadyInited");
    B.List_MUB = A._setArrayType(makeConstList([B.PlayerErrors_0_noError, B.PlayerErrors_1_invalidParameter, B.PlayerErrors_2_fileNotFound, B.PlayerErrors_3_fileLoadFailed, B.PlayerErrors_4_fileAlreadyLoaded, B.PlayerErrors_5_dllNotFound, B.PlayerErrors_6_outOfMemory, B.PlayerErrors_7_notImplemented, B.PlayerErrors_8_unknownError, B.PlayerErrors_9_nullPointer, B.PlayerErrors_10_soundHashNotFound, B.PlayerErrors_11_backendNotInited, B.PlayerErrors_12_filterNotFound, B.PlayerErrors_13_visualizationNotEnabled, B.PlayerErrors_14_maxNumberOfFiltersReached, B.PlayerErrors_15_filterAlreadyAdded, B.PlayerErrors_16_playerAlreadyInited]), A.findType("JSArray<PlayerErrors>"));
    ...
    B.MessageEvents_0 = new A.MessageEvents(0, "initEngine");
    B.MessageEvents_1 = new A.MessageEvents(1, "startLoop");
    B.MessageEvents_2 = new A.MessageEvents(2, "loop");
    B.MessageEvents_3 = new A.MessageEvents(3, "loadFile");
    B.MessageEvents_4 = new A.MessageEvents(4, "loadWaveform");
    B.MessageEvents_5 = new A.MessageEvents(5, "speechText");
    B.MessageEvents_6 = new A.MessageEvents(6, "play");
    B.MessageEvents_7 = new A.MessageEvents(7, "play3d");
    B.MessageEvents_8 = new A.MessageEvents(8, "stop");
    B.MessageEvents_9 = new A.MessageEvents(9, "disposeSound");
    B.MessageEvents_10 = new A.MessageEvents(10, "disposeAllSound");
    B.MessageEvents_11 = new A.MessageEvents(11, "loadSoLoudJS");
    B.List_ooe = A._setArrayType(makeConstList([B.MessageEvents_0, B.MessageEvents_1, B.MessageEvents_2, B.MessageEvents_3, B.MessageEvents_4, B.MessageEvents_5, B.MessageEvents_6, B.MessageEvents_7, B.MessageEvents_8, B.MessageEvents_9, B.MessageEvents_10, B.MessageEvents_11]), A.findType("JSArray<MessageEvents>"));
    B.LoadMode_0 = new A.LoadMode(0, "memory");
    B.Object_empty = {};
    B.Map_empty = new A.ConstantStringMap(B.Object_empty, [], A.findType("ConstantStringMap<Symbol0,@>"));
    B.SoundEventType_0 = new A.SoundEventType(0, "handleIsNoMoreValid");
    ...
    B.WaveForm_8 = new A.WaveForm(8, "fSaw");
  ...
  (function staticFields() {
    ...
    $.SoLoudController__instance = null;
  })();
...
//# sourceMappingURL=audio_isolate.dart.js.map
